...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p4 = new Produto(null, "Mesa de Excritório", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Aparecida", "rodrigo97.carvalho@gmail.com", "066.643.864-22", TipoCliente.PESSOAFISICA);
